    ...
    return (
        <div className='bg-base-100'>
            ...
            <form  onSubmit={handleSendReview} className='py-7'>
                        ...
                        <input type="submit" value='Send' className="input input-bordered btn btn-secondary input-lg w-full  text-white hover:bg-red-500 hover:text-white hover:bg-secondary max-w-xs font-bold uppercase mt-2" /><br />
                    </form>
        </div>
    );
};
