    ...
    return (
        <div>
            <div className='text-center bg-base-100 py-5'>
                <h1 className='text-3xl text-secondary  font-bold mb-4'>How can we help you?</h1>
                <div className='mt-5'>
                    <form ref={form} onSubmit={sendEmail} className='mt-2'>
                        ...
                        <input type="submit" value='Send' className="input input-bordered btn btn-outline input-lg w-full  text-white bg-secondary hover:bg-red-500 max-w-xs font-bold uppercase mt-2" /><br />
                    </form>
                </div>
            </div>
        </div>
